...
## Usage Constraints
- All resources must be created in the user's single assigned Region only
...
## Common Tasks
- Creating resources: Use AWS CLI or SDK, always specify `--region us-east-1` (or the user's assigned region)
